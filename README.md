...
Para evitar que Looker Studio realizara consultas pesadas a la tabla cruda de 75 MB (lo que ralentizaría el tablero y aumentaría innecesariamente el consumo del servidor en la nube), toda la lógica de negocio se transformó en **Vistas (VIEW)** dentro de MySQL. De este modo, el servidor cloud pre-calcula las agregaciones de los Aces, las efectividades por superficie y los conteos de títulos, entregándole a Looker Studio datos ya procesados y listos para pintar de forma fluida.
